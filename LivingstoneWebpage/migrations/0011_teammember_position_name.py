...
def populate_position(apps, _):
    ...
    for member in TeamMember.objects.all():
        member.position_name = PositionName.objects.get(name=member.get_position_display())
        member.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('LivingstoneWebpage', '0010_auto_20190616_1815'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='position_name',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='LivingstoneWebpage.PositionName'),
        ),
